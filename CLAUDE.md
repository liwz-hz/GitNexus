...
This project is indexed by GitNexus as **GitNexus** (4138 symbols, 9364 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
